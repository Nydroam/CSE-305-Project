...
def makeTables():
    global mycursor
    mycursor.execute('CREATE TABLE Item ( Type CHAR(50), ItemName CHAR(50), ItemID INTEGER, Price FLOAT, Seller CHAR(50), AVGRating FLOAT, NumReviews INTEGER, PRIMARY KEY(ItemID))')
